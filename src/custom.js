...
$(document).ready(function(){
    var options = {
        ...
        animationEasing: 'ease', //Nilai yang diterima: linear ease ini-out snap easeOutCubic
        ...
        neverEnding: true //aktifkan untuk membuat efek yang tidak pernah berhenti.
   ...
   //include slides quotes
    ...
    $('.slide .backstrech img').on('dragstart', function(event) {event.preventDefault(); });
